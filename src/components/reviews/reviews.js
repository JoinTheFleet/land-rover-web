...
export default class Reviews extends Component {
  ...
  loadListingReviews() {
    ListingReviewsService.index(this.props.match.id, {
  ...
  render() {
    if (this.state.initialLoad) {
      ...
      if (this.location.state && this.location.state.view && this.location.state.view !== 'listing') {
        userInfo = (
          <div>
